...
const Shortly=()=>{
    return(<>
    <div className="flex align-middle justify-center border-red-50">
        <p className='flex align-middle justify-center font-extrabold text-2xl
...
justify-between
    ">
      ...
      '>
        <Shortly/>
      <nav aria-label="Global" className="hidden md:block my-auto
